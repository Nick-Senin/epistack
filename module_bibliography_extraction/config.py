"""
Конфигурация LLM для модуля извлечения библиографической информации
...
def configure_module_llm(
    ...
    **kwargs
    ...
    """
    Настройка LLM для модуля извлечения библиографической информации
    ...
    Example:
        ...
        >>> 
        >>> # Использование специфичной модели для этого модуля
        >>> configure_module_llm(
        ...     model="openai/gpt-4",
        ...     temperature=0.3
        ... )
